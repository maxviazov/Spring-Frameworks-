...
All other dependency ranges in 4.2 remain the same as with Spring Framework 4.1.x, with - as usual - the latest minor versions of all common frameworks being officially supported now: e.g. Hibernate Validator 5.2, Jackson 2.6, Undertow 1.2.
