...
* Efficient URL matching with parsed `PathPattern`'s in Spring MVC. See [URI Patterns](https://docs.spring.io/spring/docs/current/spring-framework-reference/web.html#mvc-ann-requestmapping-uri-templates) in the reference.
